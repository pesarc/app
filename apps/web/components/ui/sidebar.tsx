...
>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        "flex h-8 shrink-0 items-center rounded-md px-2 text-[11px] font-bold uppercase tracking-widest text-sidebar-foreground/60 outline-none transition-[margin,opacity] duration-200 ease-linear [&>svg]:size-4 [&>svg]:shrink-0",
...
>(({ className, ...props }, ref) => (
  <div
    ...
    className={cn(
      "absolute right-1.5 flex h-5 min-w-5 items-center justify-center rounded-md px-1.5 text-xs font-bold tabular-nums text-sidebar-foreground select-none pointer-events-none peer-data-[active=true]/menu-button:text-sidebar-accent-foreground peer-data-[size=sm]/menu-button:top-1 peer-data-[size=default]/menu-button:top-1.5 peer-data-[size=lg]/menu-button:top-2.5 group-data-[collapsible=icon]:hidden",
      className
    )}
    {...props}
  />
